    ...
    (function(_window) {
        ...
        function drawNpsQuestionWithBorderColor(npsHtmlElement, typeOfNpsQuestion, npsColors) {
            console.clear();
            console.log('[drawNpsQuestionWithBorderColor]');
