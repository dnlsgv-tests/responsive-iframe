    ...
    (function(_window) {
        ...
        var json = {"pages":[{"name":"página1","elements":[{"type":"rating","name":"b_nps","title":"[NPS rating] Ingresa el texto requerido haciendo click aquí","isRequired":true,"requiredErrorText":{"es":"Debe ingresar una calificación"},"rateMin":0,"rateMax":10},{"type":"comment","name":"b_verbatim-1","visibleIf":"{b_nps} <= 6","title":"[NPS entre 0 y 6] Escribe el texto para cuando b_nps sea menor a 6","isRequired":true,"requiredErrorText":{"es":"Debe ingresar una respuesta"},"placeHolder":{"es":"Comente"}},{"type":"comment","name":"b_verbatim-2","visibleIf":"{b_nps} = 7 or {b_nps} = 8","title":"[NPS entre 7 y 8] Escribe el texto para cuando b_nps esté entre 7 y 8","isRequired":true,"requiredErrorText":{"es":"Debe ingresar una respuesta"},"placeHolder":{"es":"Comente"}},{"type":"comment","name":"b_verbatim-3","visibleIf":"{b_nps} >= 9","title":"[NPS entre 9 y 10] Escribe el texto para cuando b_nps esté entre 9 y 10","isRequired":true,"requiredErrorText":{"es":"Debe ingresar una respuesta"},"placeHolder":{"es":"Comente"}},{"type":"matrix","name":"pregunta1","belongsToIndexResult":"1","parsedName":"pregunta1","columns":[{"value":"Column 1","text":"columna 01"},{"value":"Column 2","text":"columna 02"},{"value":"Column 3","text":"columna 03"}],"rows":[{"value":"Row 1","text":"AAA AA"},{"value":"Row 2","text":"BBB  BBb"}]}]},{"name":"página2","elements":[{"type":"matrix","name":"pregunta2","belongsToIndexResult":"1","parsedName":"pregunta2","columns":["Column 1","Column 2","Column 3"],"rows":["Row 1","Row 2"]},{"type":"rating","name":"pregunta3","belongsToIndexResult":"1","parsedName":"pregunta3"},{"type":"rating","name":"b_nps","title":"[NPS rating] Ingresa el texto requerido haciendo click aquí","isRequired":true,"requiredErrorText":{"es":"Debe ingresar una calificación"},"belongsToIndexResult":"1","parsedName":"b_nps","rateMin":0,"rateMax":10},{"type":"text","name":"pregunta4","belongsToIndexResult":"1","parsedName":"pregunta4"}]}],"mainSurveyColor":"#C20CCC","buttonTextNotNow":"Ahora no","surveyFontFamily":"PFBeauSansPro","surveyTitleColor":"#FF0CE3","surveyQuestionNpsShape":"square","transformMatrixToMatrixDropdownOnMobileDevices":true};
