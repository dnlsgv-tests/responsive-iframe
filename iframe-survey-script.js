    ...
    (function(_window) {
        ...
        _apollo_frame.script.onAfterRenderQuestion.add(function() {
            ...
            if(newNpsShapeValue === undefined || newNpsShapeValue === 'circle') {                
                css = '@media only screen and (max-width:318px){.sv_main .sv_container .sv_body .sv_p_root .sv_q_rating{width:270px!important;display:block;margin:auto}}@media only screen and (max-width:538px){.sv_main .sv_container .sv_body .sv_p_root .sv_q_rating{width:285px;display:block;margin:auto;margin-top:20px}.sv_main .sv_container .sv_body .sv_p_root .sv_q_rating .sv_q_rating_min_text{margin-top:-25px}}@media only screen and (max-width:574px){input.sv_complete_btn{width:50%;border-radius:0!important}button#close-modal-survey-button{width:50%;margin:0!important;border-radius:0!important}.sv_main .sv_container .sv_body{padding-bottom:0!important}}';
